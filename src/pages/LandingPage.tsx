...
const LandingPage = () => {
  ...
  useEffect(() => {
    if (window.gsap) {
      ...
      // Specific animation for each card to maintain rotation
      tl.fromTo(
        ".card-left",
        { y: 100, opacity: 0, scale: 0.8, rotationX: -10, rotation: 0 },
        {
          y: 0,
          opacity: 1,
          scale: 1,
    ...
    <div className="flex flex-col w-full bg-[#fdfdfd] dark:bg-[#000000]">
      ...
      <section className="relative min-h-dvh lg:h-dvh flex flex-col items-center justify-center py-20 px-6 bg-zinc-50 dark:bg-[#050505] overflow-hidden border-y border-zinc-100 dark:border-zinc-900">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center w-full">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-md mx-auto lg:mx-0">
              <div className="space-y-3 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <h4 className="text-base">4K Rendering</h4>
              ...
              <div className="space-y-3 flex flex-col items-center lg:items-start text-center lg:text-left">
                ...
                <h4 className="text-base">Deep Linking</h4>
                <p className="text-xs text-zinc-500 leading-relaxed font-medium">
          ...
          <div
            className="relative h-[300px] sm:h-[400px] lg:h-[500px] flex items-center justify-center scale-75 sm:scale-90 lg:scale-100 mt-12 lg:mt-0 parallax-container"
            style={{ perspective: "1200px" }}
          >
            <div className="card-left absolute -left-4 lg:-left-6 top-0 w-[180px] sm:w-[220px] h-[320px] sm:h-[380px] bg-zinc-100 dark:bg-zinc-900 rounded-[2rem] sm:rounded-[2.5rem] border border-zinc-200 dark:border-zinc-800 shadow-2xl z-10 overflow-hidden">
            ...
            <div className="card-right absolute right-0 bottom-0 w-[300px] sm:w-[380px] h-[220px] sm:h-[280px] bg-white dark:bg-zinc-800 rounded-[2.5rem] sm:rounded-[3rem] border border-zinc-200 dark:border-zinc-700 shadow-2xl z-30 p-6 sm:p-8 flex flex-col justify-between text-left">
      ...
      <section className="relative min-h-dvh lg:h-dvh flex flex-col items-center justify-center px-6 py-20 bg-zinc-900 text-white overflow-hidden text-center">
        ...
        <div className="relative z-10 max-w-3xl space-y-10">
          <h2 className="text-3xl md:text-5xl font-heading tracking-tighter leading-none">
            Digital moments <br /> deserve a frame.
          </h2>
          <p className="text-base md:text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium">
            Whether it's a melody or a thought, we provide the aesthetic it
            deserves. Crafted for creators, built for fun.
          </p>
