      ...
      <div ref={containerRef} className="max-w-4xl mx-auto space-y-20">
        <header className="space-y-8 text-center fade-in">
          ...
          <h1 className="text-5xl md:text-7xl font-heading tracking-tighter leading-none">
            Frame your world. <br /> Share your story.
          </h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 fade-in">
          <div className="space-y-6">
            ...
            <h2 className="text-3xl">Just for Fun</h2>
            <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">
              ...
              high-fidelity frames for sharing your digital life. No ads,
          ...
          <div className="space-y-6">
            ...
            <h2 className="text-3xl">Personal Only</h2>
            <p className="text-lg text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">
