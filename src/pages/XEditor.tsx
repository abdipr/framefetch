...
import XPreviewArea from "@/components/editor/XPreviewArea";
import XControlsSidebar from "@/components/editor/XControlsSidebar";
import MobileDrawer from "@/components/editor/MobileDrawer";

const XEditor = () => {
  const { isMobileDrawerOpen, setMobileDrawerOpen, setFormat } = useStore();

  useEffect(() => {
    // Default to 1:1 for X for better initial visibility
    setFormat("1:1");
  }, []);
